...
- **Next:** P1 is done. Remaining roadmap — **Plan 3 (rest):** Links, Tags, KeyDates + reminders (3a Awareness #20 and **3d export/backup (D17)** now shipped). Then **P2 — M365** (gated on the Entra recon spike, risk R3). Then **P3 — AI & decks**. Optional Task-15 nicety: exercise the dossier endpoint on a couple of seeded real `nnash` records (mock-vs-real field gaps to watch: booleans as `"true"/"false"`, choice/date formats, pagination).
