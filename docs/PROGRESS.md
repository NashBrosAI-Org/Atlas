...
Last updated: 2026-06-03 (Plan 3a Awareness views shipped #20; green polish — app icon #17, demo seed data + desktop CI job + keyring fix #19; live READ path to `nnash` verified — Task 15)
